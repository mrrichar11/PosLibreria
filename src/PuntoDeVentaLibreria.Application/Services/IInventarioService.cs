...
public interface IInventarioService
{
    ...
    Task<ActualizacionPreciosResultadoDto> AplicarActualizacionPreciosAsync(IEnumerable<ArticuloAumentoPrecioItemDto> items, Guid? asignarProveedorId = null, string? asignarRubro = null, CancellationToken ct = default);
